...
class PhotoSharingActivity : AppCompatActivity() {
    ...
    fun share_button_onclick (view: android.view.View){
        val uuid = UUID.randomUUID()
        val name_image = "${uuid}.jpg"
        val reference = storage.reference
        val imageReference = reference.child("images").child(name_image)
        if (picked_image != null){
            imageReference.putFile(picked_image!!).addOnSuccessListener { taskSnapshot ->
    ...
    fun imageview_onclick (view: android.view.View){
